...
<form action="{{ route('admin.volume.store') }}" method="POST">
    ...
    <div>
        ...
        <input type="number" name="volume_number" id="volume_number" value="{{ old('volume_number') }}">
    ...
    <div>
        ...
        <input type="text" name="volume_name" id="volume_name" value="{{ old('volume_name') }}">
        @error('volume_name')
            <span>{{ $message }}</span>
        @enderror
    </div>
